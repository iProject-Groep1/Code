...
//laat alle meldingen zien die van toepassing zijn.
...
<?php
//kijk of de gebruikersnaam is meegegeven. Als dit zo is wordt de geheime vraag van de gebruiker getoond. Als dit niet zo is wordt een formulier getoond om de gebruikersnaam in te vullen.
if (isset($_GET['username']) && !empty($_GET['username'])) {
    $mail = "";
    $question = "";
    if (usernameValid($_GET['username'], $dbh)) {
        try {
            //haal mailadres en vraag op van de gebruiker.
        ...
        <!-- formulier om vraag in te vullen -->
        <div class="uk-card uk-card-default uk-card-body uk-width-1-2@s uk-width-1-3@m uk-margin-auto uk-flex uk-flex-column uk-flex-wrap-around uk-margin-medium-top uk-margin-large-bottom">
            ...
            <p class="uk-text-primary uk-text-center">Als u de geheime vraag goed beantwoord krijgt u een e-mail met een
                nieuw wachtwoord gestuurd op het volgende adres: <?= $mail ?></p>
            ...
            <form method="POST" action="scripts/forgot-password-functions.php">
                <div class="uk-margin">
                    <div class="uk-inline uk-width-1-1">
                        ...
                        <input class="uk-input" type="text" name="questionAnswer" id="questionField"
    ...
    <!-- formulier om gebruikersnaam in te vullen -->
    <div class="uk-card uk-card-default uk-card-body uk-width-1-2@s uk-width-1-3@m uk-margin-auto uk-flex uk-flex-column uk-flex-wrap-around uk-margin-medium-top uk-margin-large-bottom">
