...
?>
    <div class="uk-width-2-3 uk-align-center">
        <div class="uk-alert-danger">
            <h3 class="uk-alert-danger"><b>DISCLAIMER: DEZE WEBSITE IS NIET GEMAAKT VOOR COMMERCIELE DOELEINDEN!</b>
            </h3>
            <p>Dit is een website gemaakt door studenten, in opdracht van de Hogeschool van Arnhem en Nijmegen.</p>
        </div>
        ...
        <ul>
            ...
            <li>Uw telefoonnummer(s)</li>
            <li>Uw e-mailadres</li>
            <li>Uw geboortedatum</li>
            <li>Uw gebruikersnaam en wachtwoord (wachtwoord is beveiligd. Dit kent alleen u)</li>
            <li>Uw beveiligingsvraag en uw antwoord hierop</li>
        </ul>
        <p>Zodat u niet steeds weer uw gegevens in hoeft te voeren wordt met gebruik van een sessie uw gebruikersnaam
            opgeslagen.
            Wanneer u een bod doet op een voorwerp, wordt deze informatie (Bodprijs, datum en tijd van bieden) ook
            opgeslagen voor toekomstig gebruik op de pagina.</p>
        <p>Als verkoper kunt u voorwerpen veilen. Daarvoor verwerken wij de volgende gegevens:</p>
        <ul>
            <li>Uw bank</li>
